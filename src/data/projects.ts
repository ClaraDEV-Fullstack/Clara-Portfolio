...
export const projects: Project[] = [
    ...
    },
    {
        ...
        description:
            "SMM growth platform for social media services — Laravel + Inertia/React SPA with packages, drip-feed orders, crypto deposits, referrals, and a full admin panel (analytics, orders, transactions). Live at vyralo.net.",
        technologies: ["Laravel", "React", "TypeScript", "Inertia.js", "PostgreSQL", "Docker"],
        image: "/images/vyralo/desktop-01-home.png",
        demoUrl: "https://vyralo.net/",
        githubUrl: "",
        status: "Completed",
        featured: true,
        isPrivate: true,
